    ...
    PathView{
        ...
        delegate: Item{
            ...
            MouseArea{
                ...
                anchors.fill: parent;
                onClicked: {
                    if(delegateItem.opacity < 0.8 && delegateItem.opacity>0.6){
...
//    }
    ...
    Path{
        id:btnPath
        startX: panelWidth*0.15; startY: 20;
        PathAttribute{name: "zOrder"; value: 0}
        PathAttribute{name: "itemAlpha"; value: 0.2}
        PathAttribute{name: "itemScale"; value: 0.5}

        PathLine{x:panelWidth*0.6; y: panelHeight/2}
        PathAttribute{name: "zOrder"; value: 10}
        PathAttribute{name: "itemAlpha"; value: 1.0}
        PathAttribute{name: "itemScale"; value: 0.9}

        PathLine{x:panelWidth*0.15; y: panelHeight}
        PathAttribute{name: "zOrder"; value: 0}
        PathAttribute{name: "itemAlpha"; value: 0.2}
        PathAttribute{name: "itemScale"; value: 0.5}
